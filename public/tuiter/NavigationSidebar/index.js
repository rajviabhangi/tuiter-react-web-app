const NavigationSidebar = () => {
    ...
    <div class="list-group">
        <a class="list-group-item d-flex justify-content-start align-items-center sidebar-list-item text-muted p-xl-20" href="/"><i class="fab fa-twitter"></i></a>
        <a class="list-group-item d-flex justify-content-start align-items-center sidebar-list-item text-muted p-xl-20" href="#">
            <i class="fa fa-home fa-lg"></i><span class="d-none d-xl-block ms-3"> Home</span>
        </a>
        <a class="list-group-item sidebar-active d-flex justify-content-start align-items-center sidebar-list-item p-xl-20 bg-primary"
            href="#">
            <i class="fa fa-hashtag fa-lg fa-regular"></i> <span class="d-none d-xl-block ms-3"> Explore</span>
        </a>
        <a class="list-group-item d-flex justify-content-start align-items-center sidebar-list-item text-muted p-xl-20"
            href="#">
